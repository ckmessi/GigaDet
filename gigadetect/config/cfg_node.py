...
def get_decdet_default_cfg() -> CfgNode:
    from gigadetect.config.decdet.default import _C
    return _C.clone()

def get_gigadet_default_cfg() -> CfgNode:
    from gigadetect.config.gigadet.default import _C
    return _C.clone()